...
const FeaturesPage = () => {
  ...
  return (
    <div className="space-y-24 pb-24 text-left">
      {/* ─────────────────────────────────────────────────────────────
          HERO SECTION (Editorial Dark Theme)
         ───────────────────────────────────────────────────────────── */}
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-zinc-950 text-white pt-16 pb-20 px-4 sm:px-6 lg:px-8 border-b border-zinc-800">
        <div className="max-w-7xl mx-auto relative z-10 text-center flex flex-col items-center">
          {/* Eyebrow */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-zinc-300 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.2em] mb-6 shadow-xl">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-xs font-semibold">
            <Button
              ...
              rightIcon={<Sparkles className="w-4 h-4 text-zinc-900" />}
            >
            ...
            <a href="#estimator">
              <Button
                variant="outline"
                size="lg"
                className="bg-white/10 hover:bg-white/20 text-white border-white/25 backdrop-blur-md"
      ...
      <section id="estimator" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 scroll-mt-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 p-6 sm:p-8 rounded-2xl bg-white border border-zinc-200 shadow-soft-md space-y-7">
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="font-bold text-zinc-900 px-2.5 py-0.5 rounded bg-zinc-100 border border-zinc-200">
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] block mt-0.5 ${
                        crewSize === c.id ? 'text-zinc-300' : 'text-zinc-500'
                      }`}
                    >
                      {c.desc}
                    </span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                <label
                  ...
                  className={`p-3 rounded-xl border flex items-center justify-between cursor-pointer transition-all ${
                    addonDrone ? 'border-zinc-900 bg-zinc-50' : 'border-zinc-200 bg-white'
                  }`}
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    />
                    <div>
                      <span className="text-xs font-bold text-zinc-900 block">4K Drone Aerials</span>
                      <span className="text-[10px] text-zinc-500">Licensed DGCA Pilot</span>
                    </div>
                  </div>
                  <span className="text-xs font-bold text-zinc-700">+₹8,000</span>
                </label>

                <label
                  onClick={() => setAddonFastTeaser(!addonFastTeaser)}
                  className={`p-3 rounded-xl border flex items-center justify-between cursor-pointer transition-all ${
                    addonFastTeaser ? 'border-zinc-900 bg-zinc-50' : 'border-zinc-200 bg-white'
                  }`}
                >
                  <div className="flex items-center gap-2.5">
                    <input
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-zinc-500">Instagram/Reel Ready</span>
                    </div>
                  </div>
                  <span className="text-xs font-bold text-zinc-700">+₹4,500</span>
                </label>

                <label
                  onClick={() => setAddonRawDrive(!addonRawDrive)}
                  className={`p-3 rounded-xl border flex items-center justify-between cursor-pointer transition-all ${
                    addonRawDrive ? 'border-zinc-900 bg-zinc-50' : 'border-zinc-200 bg-white'
                  }`}
                >
                  <div className="flex items-center gap-2.5">
                    <input
                    ...
                    />
                    <div>
                      <span className="text-xs font-bold text-zinc-900 block">RAW Uncompressed Drive</span>
                      <span className="text-[10px] text-zinc-500">Courier Hard Drive</span>
                    </div>
                  </div>
                  <span className="text-xs font-bold text-zinc-700">+₹6,000</span>
                </label>

                <label
                  onClick={() => setAddonAlbum(!addonAlbum)}
                  className={`p-3 rounded-xl border flex items-center justify-between cursor-pointer transition-all ${
                    addonAlbum ? 'border-zinc-900 bg-zinc-50' : 'border-zinc-200 bg-white'
                  }`}
                >
                  <div className="flex items-center gap-2.5">
                    <input
                    ...
                    />
                    <div>
                      <span className="text-xs font-bold text-zinc-900 block">Signature Hardcover Album</span>
                      <span className="text-[10px] text-zinc-500">Fuji Matte Lustre Paper</span>
                    </div>
                  </div>
                  <span className="text-xs font-bold text-zinc-700">+₹7,500</span>
                </label>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 p-6 sm:p-8 rounded-2xl bg-zinc-950 text-white border border-zinc-800 shadow-2xl space-y-6 sticky top-24">
            <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
              <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-zinc-400">
                Estimated Production Tier
              </span>
              <span className="px-2.5 py-0.5 rounded-full bg-white/10 text-zinc-200 text-[10px] font-bold uppercase tracking-wider border border-white/20 flex items-center gap-1">
            ...
            <div>
              <span className="text-xs text-zinc-400 block mb-1">Total Estimated Investment</span>
            ...
            <div className="space-y-2.5 pt-2">
              <Button
                ...
                size="lg"
                onClick={() => setMatchmakerOpen(true)}
                className="w-full bg-white hover:bg-zinc-200 text-zinc-950 font-bold border-none"
                rightIcon={<ArrowRight className="w-4 h-4 text-zinc-900" />}
              >
              ...
              <Link to="/photographers" className="block">
                <Button
                  variant="outline"
                  size="md"
                  className="w-full bg-transparent text-zinc-300 hover:text-white border-zinc-700"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {featurePillars.map((pillar) => {
            ...
            return (
              <div
                key={pillar.id}
                className="p-7 rounded-2xl bg-white border border-zinc-200 hover:border-zinc-900 transition-all shadow-subtle hover:shadow-soft-md flex flex-col justify-between group"
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="w-10 h-10 rounded-lg bg-zinc-100 border border-zinc-200 flex items-center justify-center text-zinc-900 group-hover:bg-zinc-900 group-hover:text-white transition-all">
                      <Icon className="w-5 h-5 stroke-[1.75]" />
                    </div>
                    <span className="text-2xl font-serif font-bold text-zinc-300 group-hover:text-zinc-900 transition-colors">
                      {pillar.number}
                    </span>
                  </div>

                  <div className="space-y-1.5">
                    <h3 className="text-lg font-serif font-bold text-zinc-900 leading-snug">
                      {pillar.title}
                    </h3>
                  ...
                  <ul className="space-y-2 pt-3 border-t border-zinc-100 text-xs text-zinc-700">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="overflow-x-auto rounded-2xl border border-zinc-200 bg-white shadow-soft-md">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-zinc-200 bg-zinc-50">
                <th className="p-4 sm:p-5 text-xs font-bold uppercase tracking-wider text-zinc-700 w-1/3">
                  Capability / Feature
                </th>
                <th className="p-4 sm:p-5 text-xs font-bold uppercase tracking-wider text-zinc-500 w-1/3">
                  Traditional Unvetted Freelancing
                </th>
                <th className="p-4 sm:p-5 text-xs font-bold uppercase tracking-wider text-zinc-950 w-1/3 bg-zinc-100">
            ...
            <tbody className="divide-y divide-zinc-200 text-xs">
              {comparisonRows.map((row, idx) => (
                <tr key={idx} className="hover:bg-zinc-50/50 transition-colors">
                  ...
                  <td className="p-4 sm:p-5 text-zinc-900 font-medium bg-zinc-50/80">
                    <div className="flex items-start gap-2">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {/* Tab Content Panels */}
        <div className="p-8 sm:p-12 rounded-2xl bg-zinc-100 border border-zinc-200 space-y-8 text-zinc-900">
          {activeAudienceTab === 'clients' && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-reveal">
              <div className="p-6 rounded-xl bg-white border border-zinc-200 space-y-3 shadow-subtle">
                <ShieldCheck className="w-6 h-6 text-zinc-900" />
                <h4 className="text-base font-serif font-bold">Zero-Stress Escrow</h4>
                <p className="text-xs text-zinc-500 leading-relaxed">
              ...
              <div className="p-6 rounded-xl bg-white border border-zinc-200 space-y-3 shadow-subtle">
                ...
                <h4 className="text-base font-serif font-bold">48-Hour Social Previews</h4>
                <p className="text-xs text-zinc-500 leading-relaxed">
              ...
              <div className="p-6 rounded-xl bg-white border border-zinc-200 space-y-3 shadow-subtle">
                ...
                <h4 className="text-base font-serif font-bold">Coordinated Studios</h4>
                <p className="text-xs text-zinc-500 leading-relaxed">
          ...
          {activeAudienceTab === 'brands' && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-reveal">
              <div className="p-6 rounded-xl bg-white border border-zinc-200 space-y-3 shadow-subtle">
                ...
                <h4 className="text-base font-serif font-bold">Standard Commercial IP</h4>
                <p className="text-xs text-zinc-500 leading-relaxed">
              ...
              <div className="p-6 rounded-xl bg-white border border-zinc-200 space-y-3 shadow-subtle">
                <HardDrive className="w-6 h-6 text-zinc-900" />
                <h4 className="text-base font-serif font-bold">RAW ProRes & S-Log Deliveries</h4>
                <p className="text-xs text-zinc-500 leading-relaxed">
              ...
              <div className="p-6 rounded-xl bg-white border border-zinc-200 space-y-3 shadow-subtle">
                ...
                <h4 className="text-base font-serif font-bold">Centralized Billing & GST</h4>
                <p className="text-xs text-zinc-500 leading-relaxed">
          ...
          {activeAudienceTab === 'creators' && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-reveal">
              <div className="p-6 rounded-xl bg-white border border-zinc-200 space-y-3 shadow-subtle">
                ...
                <h4 className="text-base font-serif font-bold">Guaranteed Payouts</h4>
                <p className="text-xs text-zinc-500 leading-relaxed">
              ...
              <div className="p-6 rounded-xl bg-white border border-zinc-200 space-y-3 shadow-subtle">
                ...
                <h4 className="text-base font-serif font-bold">Curated High-Budget Clients</h4>
                <p className="text-xs text-zinc-500 leading-relaxed">
              ...
              <div className="p-6 rounded-xl bg-white border border-zinc-200 space-y-3 shadow-subtle">
                ...
                <h4 className="text-base font-serif font-bold">Studio Media Hosting</h4>
                <p className="text-xs text-zinc-500 leading-relaxed">
        ...
        <div className="space-y-3">
          {faqs.map((faq, fIdx) => {
            ...
            return (
              <div
                key={fIdx}
                className="rounded-xl bg-white border border-zinc-200 overflow-hidden shadow-subtle transition-all"
              >
                <button
                  type="button"
                  onClick={() => setOpenFaqIndex(isOpen ? null : fIdx)}
                  className="w-full p-5 flex items-center justify-between text-left gap-4 hover:bg-zinc-50 transition-colors"
                >
                ...
                {isOpen && (
                  <div className="px-5 pb-5 pt-1 text-xs text-zinc-600 leading-relaxed border-t border-zinc-100 animate-slide-up">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="p-10 sm:p-16 rounded-2xl bg-zinc-950 text-white border border-zinc-800 shadow-2xl text-center space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <button
              ...
              className="px-6 py-3 rounded-md bg-white/10 hover:bg-white/20 text-white border border-white/25 text-xs font-semibold transition-all"
            >
              Apply as Creator
            </button>
          </div>
